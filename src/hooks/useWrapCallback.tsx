...
Please file a bug detailing how this happened - https://github.com/De-Fi-Protocol-com/interface/issues/new?labels=bug&template=bug-report.md&title=Invalid%20WETH%20contract`)
                    setError(error)
                    throw error
                  }
